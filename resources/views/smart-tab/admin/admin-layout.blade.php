...
<head>
    ...
    <title>QC Smart-Tab | Dashboard</title>
        ...
        <aside class="sidebar">
            <div class="sidebar-start">
                <div class="sidebar-head">
                    <a href="{{ route('admin') }}" class="logo-wrapper" title="Home">
                        <span class="sr-only">Home</span>
                        <div class="logo-text">
                            <span class="logo-title">Smart-Tab</span>
                        </div>
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        <li>
                            <a class="show-cat-btn" href="{{ route('admin') }}" id="overview">
                                <span class="icon home" aria-hidden="true"></span>Overview

                            </a>
                        </li>

                        <li>
                            <a class="show-cat-btn" href="{{ route('limit.index') }}" id="limit">
                                <span class="icon paper" aria-hidden="true"></span>Limit
                            </a>
                        </li>
                        <li>
                            <a class="show-cat-btn" href="{{ route('worst.index') }}" id="worst">
                                <span class="icon paper" aria-hidden="true"></span>Worst
                            </a>
                        </li>
                        <li>
                            <a class="show-cat-btn" href="{{ route('standard.index') }}" id="standard">
                                <span class="icon paper" aria-hidden="true"></span>Standard
                            </a>
                        </li>

                        <li>
                            <a class="show-cat-btn" href="{{ route('report.index') }}" id="report">
                        ...
                        <li>
                            <a href="{{ route('table.index') }}" id="update-table">
